...
import { ArrowRight, Briefcase, CheckCircle, Clock, DollarSign } from "lucide-react";
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden py-20 sm:py-32">
        <div className="absolute inset-0 bg-gradient-to-b from-indigo-50 dark:from-gray-900/50 to-white dark:to-gray-900 -z-10" />
        ...
        <div className="container mx-auto px-6">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            >
              <motion.h1 
                className="text-4xl sm:text-5xl lg:text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-500"
            ...
            >
              <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-xl backdrop-blur-sm bg-opacity-80 dark:bg-opacity-80 border border-gray-100 dark:border-gray-700">
                <img
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-purple-600 via-indigo-500 to-blue-500 text-white">
        <div className="container mx-auto px-6">
          <motion.div 
